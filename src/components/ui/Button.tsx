...
export function Button({
    ...
    const baseStyles = "px-5 py-2.5 font-semibold rounded-lg transition-default text-sm inline-flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-accent-green/50 disabled:opacity-50 disabled:cursor-not-allowed";
